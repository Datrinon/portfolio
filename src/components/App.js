...
const prevTheme = window.localStorage.getItem("darkMode");

function App() {

  const [darkMode, setDarkMode] = useState(prevTheme === "1");
  ...
  // this use effect sets up some intersection observers for decal purposes.
  useEffect(() => {
